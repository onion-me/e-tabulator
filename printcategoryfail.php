  ...
  <table  class="table table-default" style="boder:1px solid black;width:50px;height:auto">
        ...
        <?php
	         ...
	         <?php
	               ...
	               $sqlscore="select a.jid,b.cannumber,b.fullname,a.canid,score as total from tblscore a inner join tblcandidate b on a.canid = b.canid where b.gender='$gender' and jid='$jid' and category='$category' group by canid order by ABS(cannumber) asc";
