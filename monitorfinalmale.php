...
?>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
          <a class="nav-link" href="printtop.php?database=<?php echo $DB; ?>&gender=male" value="print final result" >FINAL Result<span class="fa fa-print"></span></a>
      </li>
       ...
       $x=1;
        ...
        ?>
        <li class="nav-item">
        <a style="text-transform:capitalize"  class="nav-link" href="printcategorytop.php?database=<?php echo $DB; ?>&gender=male&category=<?php   echo $rowcat['category']; ?>" value="print final result" > <?php   echo $rowcat['category']; ?><span class="fa fa-print"></span> </a>
        </li>
                 <?php $x++;  } ?>
     
      <?php if($CAT=='Both'):?>
       <li class="nav-item">
          <a class="nav-link" href="monitorfinal.php?name=<?php echo $DB; ?>">Female Result<span class="fa fa-arrow-circle-right"></span></a>
      </li>
        <?php endif; ?>
         <li class="nav-item">
...
{
  setTimeout( function() {
    $('#auto').load('scorefinalfinalmale.php?db=<?php echo $DB ?>').fadeIn('slow');
    refresh();
  }, 1000);
}
</script>
