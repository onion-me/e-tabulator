...
<div class="container-fluid" id="main" style="boder:1px solid black;">
  ...
  <div class="row row-offcanvas row-offcanvas-left" style="margin-bottom:">
...
?>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
          <a class="nav-link" href="print.php?database=<?php echo $DB; ?>&gender=female" value="print final result" >FINAL Result<span class="fa fa-print"></span></a>
      </li>
       ...
       $x=1;
        ...
        ?>
        <li class="nav-item">
        <a style="text-transform:capitalize"  class="nav-link" href="printcategory.php?database=<?php echo $DB; ?>&gender=female&category=<?php   echo $rowcat['category']; ?>" value="print final result" > <?php   echo $rowcat['category']; ?><span class="fa fa-print"></span> </a>
        </li>
                 <?php $x++;  } ?>
     
      <?php if($CAT=='Both'||$CAT=='Male'):?>
       <li class="nav-item">
          <a class="nav-link" href="monitormale.php?name=<?php echo $DB; ?>">Male Result<span class="fa fa-arrow-circle-right"></span></a>
      </li>
        <?php endif; ?>
        <?php if($eli!=0): ?>
         <li class="nav-item">
...
{
  setTimeout( function() {
    $('#auto').load('scorefinal.php?db=<?php echo $DB ?>').fadeIn('slow');
    refresh();
  }, 10000);
}
</script>
