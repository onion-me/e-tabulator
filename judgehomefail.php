                                ...
                                <table class="table table-default" id="">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql="select b.cannumber,a.score as total from tblscore a inner join tblcandidate b on a.canid=b.canid where  a.category='$cat' and  a.jid='$jid' group by a.canid order by total desc";
                                            $res=mysqli_query($con,$sql);
                                            while($row=mysqli_fetch_array($res)){ 
                                        ?>
                                            <tr>
