...
?>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
          <a class="nav-link" href="print.php?database=<?php echo $DB; ?>&gender=male" value="print final result" >FINAL Result<span class="fa fa-print"></span></a>
      </li>
        ...
        $sqlnum="select category from tblcategory;";
       ...
       $x=1;
        ...
        ?>
        <li class="nav-item">
        <a style="text-transform:capitalize"  class="nav-link" href="printcategory.php?database=<?php echo $DB; ?>&gender=male&category=<?php   echo $rowcat['category']; ?>" value="print final result" > <?php   echo $rowcat['category']; ?><span class="fa fa-print"></span> </a>
        </li>
                 <?php $x++;  } ?>
        <?php if($CAT=='Both'|| $CAT=='Female' || $CAT=='Male'):?>
       <li class="nav-item">
          <a class="nav-link" href="monitor.php?name=<?php echo $DB; ?>" >Female Result<span class="fa fa-arrow-circle-right"></span></a>
      </li>
        <?php endif; ?>
        <?php if($eli!=0): ?>
         <li class="nav-item">
          <!--<a class="nav-link" href="extract.php?name=<?php echo $DB; ?>">Final Round<span class="fa fa-arrow-circle-right"></span></a>-->
                  <?php
    if($_SESSION['username']['usertype']=='organizer'): ?>
          <button align="center"  data-target="#tiebreaker<?php echo $DB;?>" data-toggle="modal" class="btn btn-dark" value="edit">Final Round</button><?php endif; ?>
        </li>
        <?php endif; ?>
...
{
  setTimeout( function() {
    $('#auto').load('scorefinalmale.php?db=<?php echo $DB ?>').fadeIn('slow');
    refresh();
  }, 1000);
}
</script>
