...
?>
        ...
        <div id="navbarNavDropdown" class="navbar-collapse collapse">
            ...
            <ul class="navbar-nav ml-auto"> 
                    <li class="nav-item" >
                        <img src="images/official logo.jpg" height="40px" width="40px">
                    </li>
                    <li> &nbsp </li>
                    <li class="nav-item" >
                        <img src="images/official logo2.jpg" height="40px" width="40px">
                    </li>
                </ul>
            <ul class="navbar-nav">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            ?>
                 ...
                 <li class="nav-item" style="border-right:3px solid silver">
                    <a class="nav-link" id="navcat" href="judgehome.php?category=<?php echo $cat; ?>" ><h4 style="text-transform: capitalize;"><?php echo $cat ?></h4></a>
                </li>
                <li class="nav-item" >
                    <h4 style="text-transform: capitalize;"><span></span></span></h4>
                </li>
 ...
 <?php if(!isset($_GET['category'])): ?>
   ...
   <div class="container text-center" style="height:80%">
	<div class="jumbotron" style="background:white;margin-bottom:;margin-top:;">
		<h1><img class='img-responsive ' height='500' width='500' src='images/logoss.jpg'></h1>
		<h3></h3>
 ...
 <?php include 'footer.php'; ?>
     <?php endif;   ?>
        <div class="container-fluid"  style="boder:3px solid violet;height:80%">
            <div class="row ">
           <div class="col-md-12  main" style="boder:1px solid blue;background-color:">
           <?php if(isset($_GET['category'])){?>
            ...
            $numberofcandidates.'<br>';
             $numberofscore=mysqli_num_rows($ress).'<br>';
                 ...
                 ?>
            <?php  if($numberofcandidates==(int)$numberofscore): ?>
   ...
   <div class="modal-body">
    <form class="form" action="finalize.php" method="POST" role="form" autocomplete="off" id="formLogin" onsubmit="backbut.disabled = true; return true;">                          
               ...
               <input type="hidden" name="database" value="<?php echo $DB;?>">     
                  ...
                  $queryy="select * from tblcategory where category='$cat'";
                  $resultt=mysqli_query($con,$queryy);
                  $singleRow = mysqli_fetch_row($resultt);
                  $sagot = $singleRow['2'];
                  $sagot = $sagot/100;
                                            $jid=$_SESSION['username']['uid'];
                                            $sql="select b.cannumber,score/'$sagot' as total from tblscore a inner join tblcandidate b on a.canid=b.canid where  a.category='$cat' and  a.jid='$jid' group by a.canid order by total desc";
                                            $res=mysqli_query($con,$sql);
                                            while($row=mysqli_fetch_array($res)){ 
                                        ?>
                                            <tr>
      ...
      <?php
       ...
       ?>
        <div class="col-sm-3  ">
        <div class="row" >
            <div class="col-md-2" id="candidate<?php echo $row['canid'] ?>" >
            </div>
 ...
 and gender = '$gender'";
   ...
   <div class="modal-body" >
    ...
    ?>
                                    ...
                                    <label form="uname1"><h5 style="text-transform: capitalize;font-weight: bold"><?php echo $row['criteria']; ?></h5></label>
                                     <script>
                                function myFunction() {
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        ?>
                             ...
                             <li class="nav-item" style="border-right:3px solid gray" >
                    <a class="nav-link" id="navcat" href="judgehome.php?category=<?php echo $cat; ?>" ><h4 style="text-transform: capitalize;"><?php echo $cat ?></h4></a>
                </li>
                <li class="nav-item" >
                    <h4 style="text-transform: capitalize;"><span></span></span></h4>
